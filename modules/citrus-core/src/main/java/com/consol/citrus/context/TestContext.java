...
public class TestContext {
    ...
    public Object getVariableObject(final String variableExpression) {
        ...
        throw new CitrusRuntimeException("Unknown variable " + variableName + ""); // TJV Modified
    }
    ...
    public void setVariable(final String variableName, Object value) {
        if (!StringUtils.hasText(variableName) || VariableUtils.cutOffVariablesPrefix(variableName).length() == 0) {
            throw new CitrusRuntimeException("Can not create variable " + variableName + ", please define proper variable name"); // TJV Modified
        }
        ...
        if (log.isDebugEnabled()) {
            log.debug("Setting variable: " + VariableUtils.cutOffVariablesPrefix(variableName) + " with value: " + value + ""); // TJV Modified
        }
